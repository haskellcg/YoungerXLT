...
namespace ConsoleDB
{
    class ServerFunction
    {
        ...
        private string DoSendFriendRequest(string formatString)
        {
            ...
            if (!dbf.IsFriend(analy.GetParaIndexOf(0), analy.GetParaIndexOf(1)) && !dbf.RequestExists(analy.GetParaIndexOf(0), analy.GetParaIndexOf(1)))
            {
        ...
        private string DoGetUserInfo(string formatString)
        {
            AnalysisStr analy = new AnalysisStr(formatString);
            DBFunction dbf = new DBFunction();
            UserInfo user = dbf.GetUserInfo(analy.GetParaIndexOf(0));
        ...
        private string DoGetGroupInfo(string formatString)
        {
            AnalysisStr analy = new AnalysisStr(formatString);
            DBFunction dbf = new DBFunction();
            GroupInfo group = dbf.GetGroupInfo(int.Parse(analy.GetParaIndexOf(0)));
        ...
        private void DoSendGroupMsg(string formatString)
        {
            ...
            string msg="Server#"+OpType.SEND_GROUP_MSG_RES+"#"+analy.GetParaIndexOf(0)+"#"+analy.GetParaIndexOf(1)+"#"+analy.GetParaFromIndex(2);
            foreach (UserInfo user in list)
            {
        ...
        private string DoGetGroupMembers(string formatString)
        {
            AnalysisStr analy = new AnalysisStr(formatString);
            DBFunction dbf = new DBFunction();
            List<UserInfo> list = dbf.GetMembersInGroup(int.Parse(analy.GetParaIndexOf(0)));
        ...
        private string DoFindUsers(string formatString)
        {
            AnalysisStr analy = new AnalysisStr(formatString);
            DBFunction dbf = new DBFunction();
            List<UserInfo> list = dbf.FindUserByName(analy.GetParaIndexOf(0));
        ...
        private string DoFindGroups(string formatString)
        {
            AnalysisStr analy = new AnalysisStr(formatString);
            DBFunction dbf = new DBFunction();
            List<GroupInfo> list = dbf.FindGroupByName(analy.GetParaIndexOf(0));
